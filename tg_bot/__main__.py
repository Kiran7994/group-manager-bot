            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="⭕️ Command Help ⭕️", url="https://t.me/{}?start=help".format(bot.username))],
                     [InlineKeyboardButton(text="📢join channel", url="t.me/unlimtedmovie00"), InlineKeyboardButton(text="🔰join our group🔰", url="https://t.me/filmgallery0999"), InlineKeyboardButton(text="💥repository💥", url="https://github.com/Kiran7994/group-manager-bot")],
